...
//         res.json({
//             error: {
//                 username:"username not match",
//             },
//         });
//     }else{
//         let dbPassword= data[0].password;
//         let isCorrectPw= bcrypt.compareSync(password,dbPassword); // true or false only
//         if(!isCorrectPw){
//              res.json({
//             error: {
...
exports.login = async (req, res) => {
  ...
  try {
    ...
    // compare password
    let isCorrectPw = bcrypt.compareSync(
      password,
      user.password
    );
